...
export const RUN_ROUTES: RunRoute[] = [
  ...
  },
  {
    ...
    description: 'Face the stage at its intended strength. Earn 25% more score and a recruitment pool scaled one stage ahead.',
    levelBonus: 0,
    bstBonus: 0,
    partySizeBonus: 0,
...
export const RUN_MILESTONES: RunMilestone[] = [
  ...
  {
    id: 'apex-hunter',
    title: 'Hard Mode Hunter',
    label: 'Hard clears',
    description: 'Clear three Hard battles during the run.',
    metric: 'apexWins',
    target: 3,
    scoreBonus: 1200,
    scoutPasses: 0,
